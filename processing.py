...
class ModelPipeline:
    ...
    def _columns_selection(self):
        self.train_cols = [col for col in self.train_data.columns if col not in ['id', 'target']]
    ...
    def _print_metrics(self):
        print("RMSE: ", np.sqrt(mean_squared_error(self.test_prediction, self.test_target)))
        print("MAPE: ", mean_absolute_percentage_error(self.test_prediction, self.test_target))
...
def main(config_file):
    ...
    # print(config)
    model_pipeline = ModelPipeline(config_file = config)
